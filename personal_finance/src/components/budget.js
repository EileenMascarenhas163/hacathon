...
export default function FinancialDashboard() {
  ...
  // New state variables for adding bills
  ...
  const handleAddBill = (name, amount, dueDate) => {
    ...
    // Reset the input fields after adding the bill
    setNewBillName("");
    setNewBillAmount("");
    setNewBillDueDate("");
  };
          ...
          <Card className="mb-8">
            ...
            <CardContent>
              <div className="flex items-center justify-between">
                <Progress
                  value={financialWellnessScore}
                  className="w-3/4 bg-gradient-to-r from-blue-500 to-blue-600"
                />
              ...
              {budgets.map((item) => (
                <div key={item.category} className="mt-4">
                  ...
                  <Slider
                    ...
                    step={10}
                    onValueChange={(value) =>
                      handleBudgetChange(item.category, value[0])
                    }
                  />
              ...
              {savingsGoals.map((goal) => (
                <div key={goal.name} className="mb-4">
                  ...
                  <Input
                    ...
                    value={goal.current}
                    onChange={(e) =>
                      handleSavingsGoalChange(goal.name, Number(e.target.value))
                    }
                    className="mt-2"
                  />
                </div>
                ...
                <div className="w-1/2">
                  ...
                  <div className="mt-4">
                    ...
                    <form
                      onSubmit={(e) => {
                        e.preventDefault();
                        handleAddBill(newBillName, Number(newBillAmount), newBillDueDate);
                      }}
                    >
                      <Input
                        name="name"
